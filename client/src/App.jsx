          ...
          skills.map( skill => {
            ...
            return (
              <li key={ skill.id }>
                { skill.name }
                {
                  auth.id && userSkill && <button onClick={ ()=> removeUserSkill(userSkill.id)}>Remove User Skill</button>
                }
                {
                  auth.id && !userSkill && <button onClick={ ()=> addUserSkill(skill.id)}>Add User Skill</button>
                }
              </li>
            );
          })
